...
namespace OpenPowerCfg.PowerManagement
{
    ...
    public class NativeMethods
    {
        ...
        public static extern UInt32 PowerReadDCValueIndex(IntPtr rootPowerKey,
        ...
        /// </returns>
        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadACValueIndex(IntPtr rootPowerKey,
            IntPtr schemeGuid, IntPtr subgroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid, ref UInt32 valueIndex);
        ...
        /// </returns>
        [DllImport("powrprof.dll", SetLastError = true)]
        internal static extern UInt32 PowerReadDescription(
            IntPtr rootPowerKey,
            IntPtr schemeGuid,
        ...
        /*      !!!! MISSED !!!!
                ...
                internal static extern bool PowerIsSettingRangeDefined(
                    IntPtr subKeyGuid,
                    IntPtr settingGuid);
        */
        public static bool PowerIsSettingRangeDefined(
            IntPtr subKeyGuid,
            IntPtr settingGuid)
        {
            UInt32 value = 0;
            return (NativeMethods.ERROR_SUCCESS == NativeMethods.PowerReadValueMin(
                                IntPtr.Zero, subKeyGuid, settingGuid, ref value));
        }

        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadSettingAttributes(
            IntPtr subGroupGuid,
            IntPtr powerSettingGuid);

        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadValueMin(
            IntPtr rootPowerKey,
            IntPtr subgroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid,
            ref UInt32 ValueMinimum);

        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadValueMax(
            IntPtr rootPowerKey,
            IntPtr subgroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid,
            ref UInt32 ValueMaximum);

        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadValueIncrement(
            IntPtr rootPowerKey,
            IntPtr subgroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid,
            ref UInt32 ValueIncrement);

        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadValueUnitsSpecifier(
            IntPtr rootPowerKey,
            IntPtr subgroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid,
            IntPtr buffer,
        ...
        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadPossibleValue(
            IntPtr rootPowerKey,
            IntPtr subGroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid,
            ref UInt32 type,
        ...
        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadPossibleDescription(
            IntPtr rootPowerKey,
            IntPtr subGroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid,
            UInt32 possibleSettingIndex,
        ...
        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerReadPossibleFriendlyName(
            IntPtr rootPowerKey,
            IntPtr subGroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid,
            UInt32 possibleSettingIndex,
        ...
        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerWriteACValueIndex(IntPtr rootPowerKey,
            IntPtr schemeGuid, IntPtr subgroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid, UInt32 valueIndex);

        [DllImport("powrprof.dll", SetLastError = true)]
        public static extern UInt32 PowerWriteDCValueIndex(IntPtr rootPowerKey,
            IntPtr schemeGuid, IntPtr subgroupOfPowerSettingsGuid,
            IntPtr powerSettingGuid, UInt32 valueIndex);
